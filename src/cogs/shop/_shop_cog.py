...
class ShopCog(commands.Cog):
    ...
    async def _sr(
        ...
        response = {
            RolesActions.ADD: _("shop-role-add_success", role_id=guild_role.id),
            RolesActions.REMOVE: _("shop-role-remove_success", role_id=guild_role.id)
        }
    ...
    async def _sk(
        ...
        response = {
            RolesActions.ADD: _("shop-key-add_success", lootbox_type=l_type.translated),
            RolesActions.REMOVE: _("shop-key-remove_success", lootbox_type=l_type.translated)
        }
